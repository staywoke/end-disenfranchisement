...
function printPetition () {
  ...
  return confirm('If you\'re registered to vote in Florida, print this petition, fill it out, then mail it back by 12/31 to ensure it’s verified by the deadline.');
}
